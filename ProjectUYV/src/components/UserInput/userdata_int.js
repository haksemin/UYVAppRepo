  ...
  return (
    <View>
      <View style={{ width: SCREEN_WIDTH - 30, height: 60, margin: 15, top: 15, borderRadius: 10, borderColor: "#B7C3D1", borderWidth: 1 }}>
        <Text style={{ fontFamily: "OpenSans", fontSize: 14, fontWeight: 700, color: "#163E6C", marginTop: 5, left: 15 }}>Bağış Tutarı</Text>
        <TextInput
          style={{ textAlignVertical: "center", fontSize: 14, left: 10, paddingBottom: 5, height: 30, width: SCREEN_WIDTH - 100, color: "black" }}
        ...
        />
        <Text style={{ position: "absolute", fontFamily: "OpenSans", fontSize: 16, fontWeight: 900, color: "#163E6C", padding: 15, right: 0 }}>₺</Text>
      </View>
