...
export default function Userdataint() {
  ...
  return (
    <View>
      <View style={{ width: SCREEN_WIDTH - 30, height: 60, margin: 7.5, borderRadius: 10, borderColor: "#B7C3D1", borderWidth: 1 ,alignSelf:"center"}}>
        <Text style={{ fontFamily: "OpenSans-Regular", fontSize: 14, fontWeight: 700, color: "#163E6C", marginTop: 5, left: 15 }}>Bağış Tutarı</Text>
        <TextInput
          style={{ textAlignVertical: "center", fontSize: 14, left: 15, paddingBottom: 5, height: 30, width: SCREEN_WIDTH - 100, color: "black",fontFamily: "OpenSans-Regular", }}
